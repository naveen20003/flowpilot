...
function WhatFlowpilotDo() {
  return (
    <div className="w-full text-black pt-25 p-2 flex flex-col gap-15 text-center">
        <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 p-5">
            <div className="flex flex-col justify-center gap-5">
                ...
                <h3 className="text-2xl md:text-3xl font-bold">Your team's attention is constantly pulled in different directions.</h3>
                <p className="text-sm md:text-md">Tasks live in one tool. Conversations happen in another. Important updates disappear in endless messages. Before long, more time is spent organizing work than actually doing it.</p>
            </div>
